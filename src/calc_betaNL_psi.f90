...
SUBROUTINE calc_betaNL_psi_v2( Nstates, psi )
  ...
  ! v2, to be used in diagonalization based KS solve
  DO ia = 1,Natoms
    DO ist = 1,Nstates
      DO ibeta = 1,NbetaNL
        betaNL_psi(ia,ist,ibeta) = ddot( Npoints, betaNL(:,ibeta),1, psi(:,ist),1 ) * dVol / sqrt(dVol)
      ENDDO 
    ENDDO 
  ENDDO 
