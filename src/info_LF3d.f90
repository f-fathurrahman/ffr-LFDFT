SUBROUTINE info_LF3d()
  ...
  WRITE(*,'(1x,A,3I8)')     'Sampling Nx, Ny, Nz = ', LF3d_NN(:)
  ...
  999 FORMAT(1x,I8,F18.10,I8,F18.10,I8,F18.10)

  ! Just in case LF3d_G2 is not allocated
  IF( allocated(LF3d_G2) ) THEN
    N = LF3d_Npoints
    WRITE(*,'(/,1x,A,/)') 'Some G2 values'
    WRITE(*,'(1x,I10,F18.10)') 1, LF3d_G2(1)
    WRITE(*,'(1x,I10,F18.10)') 2, LF3d_G2(2)
    WRITE(*,*) '       ...   .......'
    WRITE(*,'(1x,I10,F18.10)') N-1, LF3d_G2(N-1)
    WRITE(*,'(1x,I10,F18.10)') N,   LF3d_G2(N)
  ENDIF 
