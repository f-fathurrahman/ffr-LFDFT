...
!! SOURCE
 type datafiles_type
  ...
  character(len=fnlen) :: filnam_ds(5)
   ...
   ! if dataset mode, the same 5 filenames, appended with
  character(len=fnlen) :: fildensin
   ! if no dataset mode : abi
   ! if dataset mode, and getden==0 : abi
   ! if dataset mode, and getden/=0 : abo
  ...
  character(len=fnlen) :: filkss
   ! if no dataset mode : abi
   ! if dataset mode, and getkss==0 : abi
   ! if dataset mode, and getkss/=0 : abo
  character(len=fnlen) :: filqps
   ! if no dataset mode : abi
   ! if dataset mode, and getqps==0 : abi
   ! if dataset mode, and getqps/=0 : abo
  character(len=fnlen) :: filscr
   ! if no dataset mode : abi
   ! if dataset mode, and getscr==0 : abi
   ! if dataset mode, and getscr/=0 : abo
