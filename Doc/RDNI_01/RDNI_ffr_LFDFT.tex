...
\makeatother
    ...
    \section{Perhitungan struktur elektronik berdasarkan teori fungsional
kerapatan dengan fungsi Lagrange: Implementasi
awal}\label{perhitungan-struktur-elektronik-berdasarkan-teori-fungsional-kerapatan-dengan-fungsi-lagrange-implementasi-awal}

    Fadjar Fathurrahman dan Hermawan Kresno Dipojono

Program Studi Teknik Fisika dan Pusat Penelitian Nanosains dan
...
\] Pada persamaan di atas, ...
    ...
    \subsection{Implementasi}\label{implementasi}
