...
\subsection{Periodic LFs}

\begin{figure}[h]
{\centering
\includegraphics[width=0.5\textwidth]{../../tests/init/LF1d_p.pdf}
\par}
\caption{Periodic LF}
\end{figure}


\subsection{Cluster/box LFs}

\begin{figure}[h]
{\centering
\includegraphics[width=0.5\textwidth]{../../tests/init/LF1d_c.pdf}
\par}
\caption{Cluster/box LF}
\end{figure}
...
\begin{figure}[h]
{\centering
\includegraphics[width=0.5\textwidth]{../../tests/init/LF1d_sinc.pdf}
\par}
\caption{Sinc LF}
\end{figure}
