...
! TODO: add argument center
! probable add_pspot is a more appropriate for large center
!-------------------------------------
...
!------------------------------------------------------------
SUBROUTINE solve_pcg( Ncol, alpha_t, Niter, restart, doprec )
!------------------------------------------------------------
...
!------------------------------------------------------------------------------
  ...
  CALL solve_pcg( 2, 3.d-5, 1000, .FALSE., .TRUE. )
